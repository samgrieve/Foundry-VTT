...
new MidiQOL.DamageOnlyWorkflow(actor, token, damageRoll.total, "cold", hitTargets, damageRoll, {flavor: `${itemD.name} - Damage Roll (Cold)`, itemData: args[0].item, itemCardId: "new"});
await wait(1000);
